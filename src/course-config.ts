...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP1849",
  title: "The Universe Gets Stranger",
  session: "Semester 2",
  year: 2026,
  level: 1,
  ...
  endDate: "2026-10-30",
  description:
    "Begin with a dark night sky and follow the questions it refuses to " +
    "settle. This course traces one chain of explanation through cosmology, " +
    "heat, entropy, life, stars, quantum mechanics and matter, ending where " +
    "our best physical theories stop agreeing.",
  tags: ["Physics", "Cosmology", "Foundations"],
